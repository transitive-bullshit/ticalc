...
A twist off of the typical race-type games.  Race down a screen, avoiding obstacles in an 
attempt to to switch from side to side as many times as possible to achieve a high score. 
A very fast paced, suprisingly innovative game. -- By Fisch2
...
1) Send the AMOVEFST.83p file to your calculator
2) Run the AMOVEFST program (listed under the PRGM key)
...
Use the left/right arrow keys to move horizontally along the track.  The arrow keys at the top of 
the screen display the direction you're trying to get to.  Once you get all the way to one side, 
the arrows switch directions, and so, you too must try to navigate yourself to the other side.
