...
A simple game in which you try to follow a path through a minefield to the bottom of a screen.  
The catch is, the path is only displayed momentarily, so you have to remember where to go. 
-- By Fisch2
...
1) Send the AMINES.83p file to your calculator
2) Run the AMINES program (listed under the PRGM key)

Compatibility Notes:

* Supported calculators include:  TI-83, TI-83+, TI-83+ Silver Edition, and the TI-84 Plus/SE
* This program is written in TI-Basic
...
Move your character to the bottom of the screen with a limited number of lives.  Fairly self-
explanatory, yet fun in its simplicity.
